...
public class TypeReference extends SpelNodeImpl {
	...
	public TypedValue getValueInternal(ExpressionState state) throws EvaluationException {
		// RickyDelete possible optimization here if we cache the discovered type reference, but can we do that?
	...
	public void generateCode(MethodVisitor mv, CodeFlow cf) {
		// RickyDelete Future optimization - if followed by a static method call, skip generating code here
